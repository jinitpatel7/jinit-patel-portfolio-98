  ...
  return <main className="relative z-10 min-h-screen pt-24 pb-16 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        duration: 0.6
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">A selection of roles where I’ve gained experience across industry, research, and engineering teams.</p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <div className="space-y-8 md:pl-16">
            {experiences.map((experience, index) => <ExperienceCard key={experience.company} {...experience} index={index} />)}
          </div>
        </div>
        ...
        duration: 0.6
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {["MATLAB", "SolidWorks", "Creo", "Ansys Fluent", "Ansys Mechanical", "FEA", "CFD", "Python", "ML (TensorFlow, NumPy, Keras)", "C++", "3D Printing (SLA/FDM)", "CURA", "DFMA", "GD&T", "Design Reviews", "Kaizen"].map((skill, index) => <motion.div key={skill} initial={{
            opacity: 0,
            scale: 0.9
          }} whileInView={{
            opacity: 1,
