...
const horizontalImages = [
  { name: "Snowy OSU Oval", src: img5195 },
  { name: "BAPS Temple in Robbinsville, NJ", src: img0768 },
  { name: "Rare Columbus, OH aurora borealis", src: img4450 },
  { name: "Toronto skyscraper view", src: img3343 },
  { name: "Smokies - Blue Ridge Parkway, NC", src: img3612 },
  { name: "Chicago's beautiful river-side view", src: img4751 },
  { name: "$4.5 million on wheels (Pagani Huayra Roadster BC)", src: img5653 },
  { name: "Dramatic Gatlinburg, TN fenced sunset", src: img5994 },
  { name: "Early morning fog rising over Alum Creek Dam", src: img2611 },
  { name: "Typical Columbus sunset", src: img3730 },
  { name: "Lake Michigan's endless blue sky", src: img9885 },
  { name: "Smokies - Blue Ridge Parkway, NC", src: img4101 },
  { name: "Golden light streaming through Hocking Hills canopy", src: img3609 },
  { name: "Kyoto, Japan (jk just Disney Epcot lol)", src: img4963 },
  { name: "Clearwater Beach, FL sunset", src: img5183 },
];

const verticalImages = [
  { name: "Sandy, rocky Hocking Hills", src: img3643 },
  { name: "Nighttime Times Square, NYC", src: img5586 },
  { name: "Put-in-bay shore", src: img9746 },
  { name: "Universal's Volcano Bay", src: img1987 },
  { name: "Concrete Jungle - NYC", src: img3314 },
  { name: "CN Tower", src: img3464 },
  { name: "A snowy night in Toronto", src: img4308 },
  { name: "The beauty of Res on 10th", src: img7387 },
  { name: "Late spring sunset at OSU", src: img1364 },
  { name: "My backyard", src: img1826 },
  { name: "The Starry Night", src: img3653 },
  { name: "GOOO BUCKS!!!", src: img3844 },
  { name: "Columbus Water Lantern Festival", src: img3991 },
  { name: "lib park", src: img1911 },
  { name: "Cabin outdoor grill in Logan, OH", src: img3642 },
];
